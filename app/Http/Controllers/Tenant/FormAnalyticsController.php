 ...
 *
 * A thin adapter, the same shape as {@see DashboardController}: every decision about what this page may show
 * lives in {@see FormAnalyticsPresenter}, whose docblock records the five mechanisms that keep an UNGATED
 * Phase-1 surface from drifting into a second `/analytics`.
 *
