...
use App\Listeners\Webhooks\DispatchWebhooksForFormClosed;
use App\Services\Connectors\ConnectorEventDispatcher;

/**
 * Auto-discovered SYNCHRONOUS listener fanning `form.closed` out to the tenant's native-connector
 * subscriptions (H15a) — the {@see DispatchWebhooksForFormClosed} twin for the connector channel.
 *
 ...
 */
final class DispatchConnectorsForFormClosed
{
