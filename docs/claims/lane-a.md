...
## Status: NO ACTIVE CLAIM — `M105` is merged; `early-testing` holds eighteen ready rows and no open decision, so the next increment takes rows from it rather than answering questions
