...
**Measured from CI run [34078680593](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34078680593) · `push` on `main` · sha `10a71cc6b76c0bf10f34bc2e8f256e3abf93bf9a` · 2026-09-07T03:09:33Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4849 passed, 20594 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 137 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 16.9m | E2E (Playwright + axe) |
...
| pipeline-lint | 137 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 762 citations, 730 resolved, 32 unresolved, ledger 17/17 | Static analysis, style & security |
