...
**Measured from CI run [33652856516](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33652856516) · `push` on `main` · sha `b35e0d7c9f955bf1b4cf44249ba0b2e9ae45a232` · 2026-09-02T16:06:37Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4683 passed, 19879 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1440 files (bare `pint --test`, whole project) | Static analysis, style & security |
