...
**Measured from CI run [33432418563](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33432418563) · `push` on `main` · sha `2f7fae4bbee31a337ff6b51d66c2eafddf188536` · 2026-08-31T19:46:43Z**
...
| Pint | 1427 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 56 docs, 456 citations, 424 resolved, 32 unresolved, ledger 18/18 | Static analysis, style & security |
