...
**Measured from CI run [34433470503](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34433470503) · `push` on `main` · sha `d5cb42d4891eb2ccd4ecd481af73485e03c0ae2b` · 2026-09-10T03:28:36Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4894 passed, 20971 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1475 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 164 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 818 citations, 800 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
