...
**Measured from CI run [34072708139](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34072708139) · `push` on `main` · sha `89398c40b314b5b85c743e75fcbca035f54ab874` · 2026-09-07T01:20:34Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4833 passed, 20531 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 137 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 18.4m | E2E (Playwright + axe) |
...
| pipeline-lint | 131 rows, 5 held, 7 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 753 citations, 721 resolved, 32 unresolved, ledger 17/17 | Static analysis, style & security |
