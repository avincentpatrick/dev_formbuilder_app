...
**Measured from CI run [36120104502](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/36120104502) · `push` on `main` · sha `a867baf4fca6866baabffc5056d92c5f658737b9` · 2026-09-25T09:44:16Z**
...
| E2E (Playwright + axe) | 551 passed in 17.9m | E2E (Playwright + axe) |
