...
**Measured from CI run [33854744499](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33854744499) · `workflow_dispatch` on `main` · sha `c096b8b1a167648c3693080420171fe063e30a90` · 2026-09-04T08:42:40Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4740 passed, 20125 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1449 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 56 docs, 450 citations, 418 resolved, 32 unresolved, ledger 18/18 | Static analysis, style & security |
