...
**Measured from CI run [33821610871](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33821610871) · `push` on `main` · sha `af6a20a07cd6a79d1d60f19c32bc74b859598021` · 2026-09-04T00:23:39Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4736 passed, 20114 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1448 files (bare `pint --test`, whole project) | Static analysis, style & security |
