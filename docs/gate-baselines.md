...
**Measured from CI run [34046508214](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34046508214) · `push` on `main` · sha `ef847c7a75ff0e77aae25880aca49741389d8bc0` · 2026-09-06T16:46:17Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4811 passed, 20450 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1468 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 57 docs, 744 citations, 712 resolved, 32 unresolved, ledger 17/17 | Static analysis, style & security |
