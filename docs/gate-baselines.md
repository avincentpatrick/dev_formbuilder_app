...
**Measured from CI run [33374444523](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33374444523) · `push` on `main` · sha `f000a89b2cf2ee25df02c1cdf0a02dfe5aff59d4` · 2026-08-31T08:45:58Z**
...
| E2E (Playwright + axe) | 551 passed in 17.5m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1423 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 55 docs, 457 citations, 425 resolved, 32 unresolved, ledger 18/18 | Static analysis, style & security |
