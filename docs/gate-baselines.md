...
**Measured from CI run [36178509507](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/36178509507) · `push` on `main` · sha `e6662989b9329dbf16e3a917ceba3bb22734c3e6` · 2026-09-25T19:14:59Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5136 passed, 22498 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 143 files | Frontend build & type-check |
...
| Pint | 1512 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 321 rows, 5 held, 15 rule groups, 880 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 1116 citations, 1090 resolved, 26 unresolved, ledger 17/18 | Static analysis, style & security |
| test-pointer-lint | 1458 files over 4 roots, 465 test files on disk, 265 names, 2 exemptions | Static analysis, style & security |
