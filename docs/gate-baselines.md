...
**Measured from CI run [34014299279](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34014299279) · `push` on `main` · sha `afdae1b9f8432c3017d8520bb9908cac04e766d1` · 2026-09-06T05:33:54Z**
...
| Pint | 1467 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 56 docs, 457 citations, 425 resolved, 32 unresolved, ledger 17/18 | Static analysis, style & security |
