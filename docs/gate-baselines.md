...
**Measured from CI run [35448937588](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/35448937588) · `push` on `main` · sha `77a268d1be8f0f4a32d0e686e13e229ca2b7665f` · 2026-09-19T14:30:17Z**
...
| E2E (Playwright + axe) | 551 passed in 18.2m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1498 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 289 rows, 5 held, 15 rule groups, 876 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 925 citations, 907 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
