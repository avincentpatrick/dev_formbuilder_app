...
**Measured from CI run [35999961578](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/35999961578) · `push` on `main` · sha `e6d10f144d6702ab2fcb93685c957ec1a9be5613` · 2026-09-24T12:34:58Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5091 passed, 22076 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1505 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 285 rows, 5 held, 15 rule groups, 878 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 973 citations, 955 resolved, 18 unresolved, ledger 17/18 | Static analysis, style & security |
| test-pointer-lint | 1451 files over 4 roots, 460 test files on disk, 261 names, 2 exemptions | Static analysis, style & security |
