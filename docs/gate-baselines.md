...
**Measured from CI run [33934552535](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33934552535) · `push` on `main` · sha `3d8c0ae6f899ead8d6468159519564e517d45ce7` · 2026-09-05T00:55:30Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4749 passed, 20155 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1451 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 56 docs, 451 citations, 419 resolved, 32 unresolved, ledger 18/18 | Static analysis, style & security |
