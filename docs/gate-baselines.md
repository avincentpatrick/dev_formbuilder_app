...
**Measured from CI run [33417847170](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33417847170) · `push` on `main` · sha `dcd3309446bf9fda61b2220ab526f7fe3a079bb8` · 2026-08-31T17:07:23Z**
...
| E2E (Playwright + axe) | 551 passed in 17.2m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1426 files (bare `pint --test`, whole project) | Static analysis, style & security |
