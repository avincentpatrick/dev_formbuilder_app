...
**Measured from CI run [36118040711](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/36118040711) · `push` on `main` · sha `049b518e18592b0403e147c02b956304f37cc937` · 2026-09-25T09:22:12Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5099 passed, 22124 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 142 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 18.0m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1507 files (bare `pint --test`, whole project) | Static analysis, style & security |
| controller-gate | 98 controllers | Static analysis, style & security |
| migration-lint | 118 migrations | Static analysis, style & security |
| job-payload-lint | 31 jobs | Static analysis, style & security |
| constraint-boundary-lint | 118 migrations, 121 constraints, 0 unresolved | Static analysis, style & security |
| component-import-lint | 180 SFCs | Static analysis, style & security |
| pipeline-lint | 320 rows, 5 held, 15 rule groups, 878 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 1085 citations, 1059 resolved, 26 unresolved, ledger 17/18 | Static analysis, style & security |
| test-pointer-lint | 1453 files over 4 roots, 462 test files on disk, 263 names, 2 exemptions | Static analysis, style & security |

**E2E extras:** 13 skipped · no flaky line — `failOnFlakyTests` makes a flaky result RED, so the absence of
