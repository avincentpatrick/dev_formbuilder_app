...
**Measured from CI run [34136140167](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34136140167) · `push` on `main` · sha `8ae8e0a2723efe4866a0af54eed92b6cb343b53d` · 2026-09-07T15:01:51Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4863 passed, 20627 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 137 files | Frontend build & type-check |
...
| Pint | 1471 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 154 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 787 citations, 769 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
