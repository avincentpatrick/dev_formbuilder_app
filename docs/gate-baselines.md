...
**Measured from CI run [35516311967](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/35516311967) · `push` on `main` · sha `a0132f838ca3c85ea80205289844d83c1328268b` · 2026-09-20T14:22:58Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5085 passed, 22053 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 142 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 18.1m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1504 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 283 rows, 5 held, 15 rule groups, 878 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 963 citations, 945 resolved, 18 unresolved, ledger 17/18 | Static analysis, style & security |
