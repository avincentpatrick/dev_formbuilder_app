...
**Measured from CI run [33746158966](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33746158966) · `push` on `main` · sha `760efa55ed5fcc84d56214ceac43b97770c5586e` · 2026-09-03T10:47:05Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4715 passed, 19975 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1442 files (bare `pint --test`, whole project) | Static analysis, style & security |
