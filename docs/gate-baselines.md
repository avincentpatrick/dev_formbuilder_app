...
**Measured from CI run [33465526827](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33465526827) · `push` on `main` · sha `757fbd9069d3e3f3dece567b46d2cef12548cf0a` · 2026-09-01T03:15:02Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4636 passed, 19647 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1436 files (bare `pint --test`, whole project) | Static analysis, style & security |
