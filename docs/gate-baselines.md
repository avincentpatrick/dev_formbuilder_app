...
**Measured from CI run [34927803743](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34927803743) · `push` on `main` · sha `e853b79e65095ce3e7ed3c534f0569690a8825ae` · 2026-09-15T04:10:35Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5016 passed, 21596 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1489 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 259 rows, 5 held, 15 rule groups, 875 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 894 citations, 876 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
| test-pointer-lint | 1439 files over 4 roots, 455 test files on disk, 257 names, 2 exemptions | Static analysis, style & security |
