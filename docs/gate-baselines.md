...
**Measured from CI run [33456999435](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33456999435) · `push` on `main` · sha `26505fbdac7c8cf60cffa4aad21db5ac55e9e387` · 2026-09-01T01:00:02Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4630 passed, 19637 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1433 files (bare `pint --test`, whole project) | Static analysis, style & security |
