...
**Measured from CI run [34490284120](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34490284120) · `push` on `main` · sha `bd64b622ea1de96fcd1d8d5821a040a34191e670` · 2026-09-10T14:37:34Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4905 passed, 21016 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1478 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 165 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 821 citations, 803 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
| test-pointer-lint | 450 test files, 197 names, 2 exemptions | Static analysis, style & security |
