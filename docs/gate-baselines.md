...
**Measured from CI run [33996014965](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33996014965) · `push` on `main` · sha `593a900af3a07e9e67396d1ccaf7db870741d3a6` · 2026-09-05T22:28:41Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4802 passed, 20416 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 135 files | Frontend build & type-check |
...
| Pint | 1465 files (bare `pint --test`, whole project) | Static analysis, style & security |
