...
**Measured from CI run [34005330943](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34005330943) · `push` on `main` · sha `1685fafeadfc49f17e0ee6b6c953f94fd1ed60e6` · 2026-09-06T02:00:14Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4806 passed, 20431 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 136 files | Frontend build & type-check |
...
| Pint | 1466 files (bare `pint --test`, whole project) | Static analysis, style & security |
