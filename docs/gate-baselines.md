...
**Measured from CI run [36211679561](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/36211679561) · `push` on `main` · sha `17e0b0dfffe569b07d87dbeb83af12a61d9a9585` · 2026-09-26T02:26:10Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5160 passed, 22674 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1513 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 320 rows, 5 held, 15 rule groups, 880 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 1158 citations, 1132 resolved, 26 unresolved, ledger 17/18 | Static analysis, style & security |
| test-pointer-lint | 1459 files over 4 roots, 466 test files on disk, 267 names, 2 exemptions | Static analysis, style & security |
