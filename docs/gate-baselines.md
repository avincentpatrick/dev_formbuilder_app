...
**Measured from CI run [33780360164](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33780360164) · `push` on `main` · sha `cd2397d4265056e098590a0ebe9af53360ac6e40` · 2026-09-03T16:43:47Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4731 passed, 20074 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 134 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 19.3m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1446 files (bare `pint --test`, whole project) | Static analysis, style & security |
