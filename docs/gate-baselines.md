...
**Measured from CI run [34119878934](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34119878934) · `push` on `main` · sha `6c0a483e2d8255562026c7cc0834a1418fa5480d` · 2026-09-07T12:04:19Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4862 passed, 20624 assertions | Tests (Pest on PostgreSQL) |
...
| pipeline-lint | 150 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 782 citations, 764 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
