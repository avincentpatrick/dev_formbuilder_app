...
**Measured from CI run [35313412778](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/35313412778) · `push` on `main` · sha `93b8dae88c79475cacb64b705facc431360c48da` · 2026-09-18T06:05:28Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5045 passed, 21877 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 141 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 18.7m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1493 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 285 rows, 5 held, 15 rule groups, 875 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 915 citations, 897 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
| test-pointer-lint | 1442 files over 4 roots, 458 test files on disk, 259 names, 2 exemptions | Static analysis, style & security |
