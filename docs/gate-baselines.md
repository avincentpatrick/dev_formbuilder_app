...
**Measured from CI run [33617645371](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33617645371) · `push` on `main` · sha `df48e1b0ef5bef24a57007d675455b6b1bae0e35` · 2026-09-02T10:05:37Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4661 passed, 19751 assertions | Tests (Pest on PostgreSQL) |
