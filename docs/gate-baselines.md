...
**Measured from CI run [34092745811](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34092745811) · `push` on `main` · sha `5112ee99029d62f6b6791e084f15b00f8d794d12` · 2026-09-07T06:52:14Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4851 passed, 20613 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1470 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 144 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 770 citations, 738 resolved, 32 unresolved, ledger 17/17 | Static analysis, style & security |
