...
**Measured from CI run [33581331431](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33581331431) · `push` on `main` · sha `34514c9309a401e101f240711529cb2d4afcbd1a` · 2026-09-02T01:56:37Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4642 passed, 19692 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1438 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 56 docs, 455 citations, 423 resolved, 32 unresolved, ledger 18/18 | Static analysis, style & security |
