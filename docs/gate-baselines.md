...
**Measured from CI run [33237905836](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33237905836) · `push` on `main` · sha `6dbe942e072740e45de5455a78cd6a2f04d2a4cc` · 2026-08-29T06:12:06Z**
...
| E2E (Playwright + axe) | 551 passed in 17.7m | E2E (Playwright + axe) |
...
| citation-liveness-lint | 55 docs, 460 citations, 428 resolved, 32 unresolved, ledger 19/19 | Static analysis, style & security |
