...
**Measured from CI run [34825481005](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34825481005) · `push` on `main` · sha `786afd6c71c41f90f412b5282d602c6e6915db8d` · 2026-09-14T08:58:54Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4929 passed, 21213 assertions | Tests (Pest on PostgreSQL) |
...
| pipeline-lint | 223 rows, 5 held, 15 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 859 citations, 841 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
