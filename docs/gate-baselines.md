...
**Measured from CI run [33957513495](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33957513495) · `push` on `main` · sha `f5551484c824fa9562f8dd13833a312e52b0f324` · 2026-09-05T09:16:01Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4766 passed, 20259 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1458 files (bare `pint --test`, whole project) | Static analysis, style & security |
