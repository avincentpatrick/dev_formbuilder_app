...
**Measured from CI run [36106067000](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/36106067000) · `push` on `main` · sha `5b94314e9decc17606adb417fe6c5fcf7adf5d4e` · 2026-09-25T07:07:22Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5094 passed, 22092 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1506 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 57 docs, 1067 citations, 1043 resolved, 24 unresolved, ledger 17/18 | Static analysis, style & security |
| test-pointer-lint | 1452 files over 4 roots, 461 test files on disk, 262 names, 2 exemptions | Static analysis, style & security |
