...
**Measured from CI run [33725986692](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33725986692) · `push` on `main` · sha `730a2d9d01170c3298b3e8292c6e6da0ed7bb513` · 2026-09-03T07:01:02Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4695 passed, 19934 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1441 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 56 docs, 452 citations, 420 resolved, 32 unresolved, ledger 18/18 | Static analysis, style & security |
