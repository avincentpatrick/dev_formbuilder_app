...
**Measured from CI run [34523438463](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34523438463) · `push` on `main` · sha `12b4a314ea68ec65890e4c62588fa1b6f1ae77e8` · 2026-09-10T19:57:20Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4910 passed, 21081 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 138 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 18.5m | E2E (Playwright + axe) |
...
| pipeline-lint | 167 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 838 citations, 820 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
| test-pointer-lint | 451 test files, 197 names, 2 exemptions | Static analysis, style & security |
