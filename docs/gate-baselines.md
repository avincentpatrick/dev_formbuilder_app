...
**Measured from CI run [33471949734](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33471949734) · `push` on `main` · sha `220f827abe969f81d490e78506587e602667c43c` · 2026-09-01T05:00:36Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4638 passed, 19665 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1437 files (bare `pint --test`, whole project) | Static analysis, style & security |
