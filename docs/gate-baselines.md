...
**Measured from CI run [33398663198](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33398663198) · `push` on `main` · sha `56fbb49936418bddffcf63f79954da9f3aef2278` · 2026-08-31T13:44:57Z**
...
| Pint | 1424 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 56 docs, 457 citations, 425 resolved, 32 unresolved, ledger 18/18 | Static analysis, style & security |
