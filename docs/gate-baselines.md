...
**Measured from CI run [34107209867](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34107209867) · `push` on `main` · sha `fda96018e064dfbf042e1e626984c4078a8b9819` · 2026-09-07T09:38:59Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4856 passed, 20647 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 137 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 15.4m | E2E (Playwright + axe) |
...
| pipeline-lint | 146 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 774 citations, 742 resolved, 32 unresolved, ledger 17/17 | Static analysis, style & security |
