...
**Measured from CI run [34424845327](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34424845327) · `push` on `main` · sha `ee8ca269a26e8e75214bb01b19c3c1cc3090dff3` · 2026-09-10T01:17:02Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4878 passed, 20819 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1473 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 161 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 795 citations, 777 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
