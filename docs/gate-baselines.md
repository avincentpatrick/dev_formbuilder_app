...
**Measured from CI run [33946363959](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33946363959) · `push` on `main` · sha `05368b2a87b70abc23d5409757291568970f764f` · 2026-09-05T05:07:15Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4759 passed, 20216 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 134 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 15.7m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1453 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 56 docs, 454 citations, 422 resolved, 32 unresolved, ledger 17/18 | Static analysis, style & security |
