...
**Measured from CI run [33982467143](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/33982467143) · `push` on `main` · sha `07d32baa6ccb65269aeae7fbaa6f9ee423c95897` · 2026-09-05T17:55:44Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4793 passed, 20364 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1462 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| citation-liveness-lint | 56 docs, 455 citations, 423 resolved, 32 unresolved, ledger 17/18 | Static analysis, style & security |
