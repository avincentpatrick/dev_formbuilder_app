...
**Measured from CI run [35506925970](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/35506925970) · `push` on `main` · sha `429857d2acc544aaa021a190110ec4e4a2333de5` · 2026-09-20T11:06:47Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5073 passed, 22014 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 141 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 18.3m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1499 files (bare `pint --test`, whole project) | Static analysis, style & security |
| controller-gate | 97 controllers | Static analysis, style & security |
| migration-lint | 116 migrations | Static analysis, style & security |
| job-payload-lint | 31 jobs | Static analysis, style & security |
| constraint-boundary-lint | 116 migrations, 121 constraints, 0 unresolved | Static analysis, style & security |
| component-import-lint | 180 SFCs | Static analysis, style & security |
| pipeline-lint | 282 rows, 5 held, 15 rule groups, 876 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 961 citations, 943 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
| test-pointer-lint | 1446 files over 4 roots, 459 test files on disk, 260 names, 2 exemptions | Static analysis, style & security |
