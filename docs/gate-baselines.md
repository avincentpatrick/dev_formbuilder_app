...
**Measured from CI run [34919222141](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34919222141) · `push` on `main` · sha `1af40e6ba30f897f7ecb1a3ad4e0185848d697fd` · 2026-09-15T01:56:18Z**
...
| E2E (Playwright + axe) | 551 passed in 18.6m | E2E (Playwright + axe) |
...
| pipeline-lint | 256 rows, 5 held, 15 rule groups, 875 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 891 citations, 873 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
