...
**Measured from CI run [34816728170](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34816728170) · `push` on `main` · sha `52bab4fd0099776a5cdc60fe4d5e7f02b0ca1e30` · 2026-09-14T07:11:53Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4929 passed, 21209 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1479 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 219 rows, 5 held, 15 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 855 citations, 837 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
| test-pointer-lint | 1429 files over 4 roots, 451 test files on disk, 253 names, 2 exemptions | Static analysis, style & security |
