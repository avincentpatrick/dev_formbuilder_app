...
**Measured from CI run [35441718315](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/35441718315) · `push` on `main` · sha `f39854acb84dd03e30f4eaf7914d4f2975664cc6` · 2026-09-19T12:02:02Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5054 passed, 21917 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 141 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 16.8m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1495 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 289 rows, 5 held, 15 rule groups, 875 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 926 citations, 908 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
| test-pointer-lint | 1443 files over 4 roots, 459 test files on disk, 259 names, 2 exemptions | Static analysis, style & security |
