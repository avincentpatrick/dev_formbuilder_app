...
**Measured from CI run [34797480912](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34797480912) · `push` on `main` · sha `8de5151f91895a40c2d03dbf35a8cbcb943858b3` · 2026-09-14T01:55:33Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4916 passed, 21142 assertions | Tests (Pest on PostgreSQL) |
...
| pipeline-lint | 173 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 845 citations, 827 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
