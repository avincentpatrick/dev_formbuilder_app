...
**Measured from CI run [35282017774](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/35282017774) · `push` on `main` · sha `64242dfaf5eec3a786f663c24177fadff742d81e` · 2026-09-17T22:26:18Z**
...
|---|---|---|
| Pest (PostgreSQL) | 5022 passed, 21787 assertions | Tests (Pest on PostgreSQL) |
...
| Pint | 1490 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 282 rows, 5 held, 15 rule groups, 875 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 914 citations, 896 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
| test-pointer-lint | 1440 files over 4 roots, 456 test files on disk, 257 names, 2 exemptions | Static analysis, style & security |
