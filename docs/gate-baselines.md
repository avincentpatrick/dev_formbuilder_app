...
**Measured from CI run [34189922929](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34189922929) · `push` on `main` · sha `30c32419187fd64f43c7144bd75731382559a9ac` · 2026-09-08T05:15:15Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4871 passed, 20660 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 138 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 17.6m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1472 files (bare `pint --test`, whole project) | Static analysis, style & security |
...
| pipeline-lint | 156 rows, 5 held, 11 rule groups, 869 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 792 citations, 774 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
