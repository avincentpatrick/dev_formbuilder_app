...
**Measured from CI run [34851593627](https://github.com/avincentpatrick/dev_formbuilder_app/actions/runs/34851593627) · `push` on `main` · sha `f87b793d14cb57db8c40fa03a9db20e9dc4c40a9` · 2026-09-14T13:49:01Z**
...
|---|---|---|
| Pest (PostgreSQL) | 4983 passed, 21484 assertions | Tests (Pest on PostgreSQL) |
| Vitest | 138 files | Frontend build & type-check |
| Storybook axe | 42 suites, 303 tests | Design system a11y (axe) |
| E2E (Playwright + axe) | 551 passed in 15.6m | E2E (Playwright + axe) |
| PHPStan | OK, no errors | Static analysis, style & security |
| Pint | 1486 files (bare `pint --test`, whole project) | Static analysis, style & security |
| controller-gate | 97 controllers | Static analysis, style & security |
| migration-lint | 114 migrations | Static analysis, style & security |
| job-payload-lint | 31 jobs | Static analysis, style & security |
| constraint-boundary-lint | 114 migrations, 121 constraints, 0 unresolved | Static analysis, style & security |
| component-import-lint | 180 SFCs | Static analysis, style & security |
| pipeline-lint | 235 rows, 5 held, 15 rule groups, 874 files | Static analysis, style & security |
| citation-liveness-lint | 57 docs, 871 citations, 853 resolved, 18 unresolved, ledger 18/18 | Static analysis, style & security |
| test-pointer-lint | 1436 files over 4 roots, 453 test files on disk, 255 names, 2 exemptions | Static analysis, style & security |
