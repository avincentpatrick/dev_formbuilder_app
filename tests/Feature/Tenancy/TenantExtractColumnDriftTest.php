...
const EXTRACTED_COLUMN_CENSUS = [
    ...
    'sso_auth_requests' => 'completed_at consumed_at created_at expires_at force_authn id intent ip_address issued_at request_id return_to sso_connection_id tenant_id updated_at user_id verified_at',
