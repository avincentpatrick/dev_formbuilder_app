...
const EXTRACTED_COLUMN_CENSUS = [
    ...
    'users' => 'created_at deleted_at email email_verified_at google_id id is_super_admin last_active_tenant_id name password password_set_at privacy_policy_accepted_at remember_token tos_accepted_at two_factor_confirmed_at two_factor_recovery_codes two_factor_secret updated_at welcomed_at',
